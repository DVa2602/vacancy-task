<x-app-layout>
    ...
    <div class="h1 mt-3">{{ __('Create') }}</div>
    <div class="mt-5">
        <form method="POST" action="{{route('book.store')}}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="descript" name="description" value="{{ old('description')}}">
              @error('description')
                ...
                <div class="overflow-auto" style="height: 200px; width:300px">
                    @foreach ( $authors as $author)
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" name="authors[]" @if( in_array($author->id, old('authors',[])) )checked @endIf value="{{$author->id}}" id="{{$author->id}}">
